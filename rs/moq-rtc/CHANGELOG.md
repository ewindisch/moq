...
## [0.0.2](https://github.com/moq-dev/moq/compare/moq-rtc-v0.0.1...moq-rtc-v0.0.2) - 2026-07-03

### Other

- [codex] Fix moq-rtc loopback ICE fallback ([#2022](https://github.com/moq-dev/moq/pull/2022))
...
- emit a valid rejected m-line in SDP answers ([#1964](https://github.com/moq-dev/moq/pull/1964))
